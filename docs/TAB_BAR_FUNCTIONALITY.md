...
interface NavigationTab {
  id: string;           // Unique identifier (e.g., 'home', 'feed')
...
**Flow**:
1. Guest attempts to access `/home`, `/feed`, or any tab
...
7. Admin reorders tabs:
   a. Admin taps down arrow on "Home" (order 1)
   b. System calls updateTabOrder('home', 2)
